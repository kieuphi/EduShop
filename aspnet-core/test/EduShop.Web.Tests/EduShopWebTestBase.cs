...
namespace EduShop.Web.Tests
{
    public abstract class EduShopWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EduShopWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EduShopWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EduShopDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EduShopDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EduShopDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EduShopDbContext, Task<T>> func)
        {
            T result;
